...
Public Class frmStockReport
    ...
    Public Sub repsalesLocationfrom()
        ...
        Try
            Dim Query As String
            ds.Dispose()
            Query = "select LOCN_CODE as loccode, LOCN_CODE || '-' || LOCN_SHORT_NAME as locdisplay from om_location order by locdisplay"

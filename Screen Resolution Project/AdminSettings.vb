...
Public Class AdminSettings
    ...
    Private Sub Settings_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not settingsarray.Contains("Counter Settings") Then
            ...
            Dim tooltipUploadLogoEdit As New ToolTip
            tooltipUploadLogoEdit.SetToolTip(btnUploadLogoEdit, "Upload Logo")
            Dim tooltipBrowseLogoEdit As New ToolTip
            tooltipBrowseLogoEdit.SetToolTip(btnBrowseLogoEdit, "Browse Logo")
                            ...
                            Else
                                Try
                                    ...
                                    If Not apiURL Is Nothing And Not apiURL.Equals("") Then
                                        ...
                                        Client.Dispose()
                                    End If
                                    If Not File.Exists(Application.StartupPath & "\LOGOS\" & row.Item(1).ToString) Then
    ...
    Private Sub btnBrowseLogoEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowseLogoEdit.Click
        Try
            ...
            If Not Path.GetDirectoryName(dialog.FileName).ToString = Application.StartupPath & "\LOGOS" Then
                ...
                dialog.Dispose()
            ElseIf File.Exists(dialog.FileName) Then
                picboxLogoEdit.BackgroundImage = Image.FromFile(dialog.FileName)
                lblLogoNameEdit.Text = System.IO.Path.GetFileName(dialog.FileName)
            End If
        Catch ex As Exception

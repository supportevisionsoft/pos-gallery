...
Public Class DailyTransReport
    ...
    Private lblItemGrossTotalHead As New List(Of Label)
    Private lblItemTotalDiscount As New List(Of Label)
    Private lblItemTotalDiscountHeader As New List(Of Label)
    ...
    Private Sub btView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btView.Click
        ...
        Try
            ...
            If cmbSm.Text = "All" Then
                ...
                stQuery = "select INVH_SYS_ID,INVH_NO,INVH_TXN_CODE,to_char(INVH_DT,'DD/MM/YYYY'),SM_NAME from ot_invoice_head,om_salesman where INVH_SM_CODE=SM_CODE and INVH_COMP_CODE='" & CompanyCode & "' and INVH_TXN_CODE='POSINV' and INVH_DOC_SRC_LOCN_CODE='" & cmbLocation.Text & "' and INVH_DT>='" & dtstDate.Value.ToString("dd-MMM-yy") & "' and INVH_DT<='" & dtendDate.Value.ToString("dd-MMM-yy") & "' order by INVH_DOC_SRC_LOCN_CODE, INVH_NO"
            Else
                ...
                stQuery = "select INVH_SYS_ID,INVH_NO,INVH_TXN_CODE,to_char(INVH_DT,'DD/MM/YYYY'),SM_NAME from ot_invoice_head,om_salesman where INVH_SM_CODE=SM_CODE and INVH_COMP_CODE='" & CompanyCode & "' and INVH_TXN_CODE='POSINV' and INVH_DOC_SRC_LOCN_CODE='" & cmbLocation.Text & "' and INVH_SM_CODE='" & cmbSm.Text & "' and INVH_DT>='" & dtstDate.Value.ToString("dd-MMM-yy") & "' and INVH_DT<='" & dtendDate.Value.ToString("dd-MMM-yy") & "' order by INVH_DOC_SRC_LOCN_CODE, INVH_NO"
            End If
            errLog.WriteToErrorLog("Daily Transaction Report Invoice Query", stQuery, "")
            ds = db.SelectFromTableODBC(stQuery)
            ...
            If ds.Tables("Table").Rows.Count > 0 Then
                ...
                With lbl
                    ...
                    .Location = New Point(400, currentpositon)
                    .Size = New Size(190, 20)
                    .BackColor = Color.LightGray
                    .Font = New Font("Times New Roman", 9, FontStyle.Bold)
                    .Text = "Invoice Transaction Net Total"
            ...
            If cmbSm.Text = "All" Then
                ...
                stQuery = "select SOH_SYS_ID,SOH_NO,SOH_TXN_CODE,to_char(SOH_DT,'DD/MM/YYYY'),SM_NAME from OT_SO_HEAD,om_salesman where SOH_SM_CODE=SM_CODE and SOH_COMP_CODE='" & CompanyCode & "' and SOH_TXN_CODE='SO' and SOH_DOC_SRC_LOCN_CODE='" & cmbLocation.Text & "'  and SOH_DT>='" & dtstDate.Value.ToString("dd-MMM-yy") & "' and SOH_DT<='" & dtendDate.Value.ToString("dd-MMM-yy") & "' order by SOH_DOC_SRC_LOCN_CODE,SOH_NO"
            Else
                ...
                stQuery = "select SOH_SYS_ID,SOH_NO,SOH_TXN_CODE,to_char(SOH_DT,'DD/MM/YYYY'),SM_NAME from OT_SO_HEAD,om_salesman where SOH_SM_CODE=SM_CODE and SOH_COMP_CODE='" & CompanyCode & "' and SOH_TXN_CODE='SO' and SOH_DOC_SRC_LOCN_CODE='" & cmbLocation.Text & "'  and SOH_SM_CODE='" & cmbSm.Text & "' and SOH_DT>='" & dtstDate.Value.ToString("dd-MMM-yy") & "' and SOH_DT<='" & dtendDate.Value.ToString("dd-MMM-yy") & "' order by SOH_DOC_SRC_LOCN_CODE,SOH_NO"
            End If
            ds = db.SelectFromTableODBC(stQuery)
            ...
            If ds.Tables("Table").Rows.Count > 0 Then
                ...
                With lbl
                    ...
                    .BackColor = Color.LightGray
                    .Font = New Font("Times New Roman", 9, FontStyle.Bold)
                    .Text = "Sales Order Transaction Net Total"
                    .TextAlign = ContentAlignment.MiddleRight
                    '.BorderStyle = BorderStyle.FixedSingle
                End With
                Me.lblItemGrossTotal.Add(lbl)
            ...
            If cmbSm.Text = "All" Then
                ...
                stQuery = "select  CSRH_SYS_ID,CSRH_NO,CSRH_TXN_CODE,to_char(CSRH_DT,'DD/MM/YYYY'),SM_NAME from OT_CUST_SALE_RET_HEAD,om_salesman where CSRH_SM_CODE=SM_CODE and  CSRH_COMP_CODE='" & CompanyCode & "' and CSRH_TXN_CODE='SARTN' and CSRH_DOC_SRC_LOCN_CODE='" & cmbLocation.Text & "'  and CSRH_DT>='" & dtstDate.Value.ToString("dd-MMM-yy") & "' and CSRH_DT<='" & dtendDate.Value.ToString("dd-MMM-yy") & "' order by CSRH_DOC_SRC_LOCN_CODE,CSRH_NO"
            Else
                ...
                stQuery = "select  CSRH_SYS_ID,CSRH_NO,CSRH_TXN_CODE,to_char(CSRH_DT,'DD/MM/YYYY'),SM_NAME from OT_CUST_SALE_RET_HEAD,om_salesman where CSRH_SM_CODE=SM_CODE and  CSRH_COMP_CODE='" & CompanyCode & "' and CSRH_TXN_CODE='SARTN' and CSRH_DOC_SRC_LOCN_CODE='" & cmbLocation.Text & "' and CSRH_SM_CODE='" & cmbSm.Text & "' and CSRH_DT>='" & dtstDate.Value.ToString("dd-MMM-yy") & "' and CSRH_DT<='" & dtendDate.Value.ToString("dd-MMM-yy") & "' order by CSRH_DOC_SRC_LOCN_CODE,CSRH_NO"
            End If
            ...
            If ds.Tables("Table").Rows.Count > 0 Then
                ...
                With lbl
                    ...
                    .BackColor = Color.LightGray
                    .Font = New Font("Times New Roman", 9, FontStyle.Bold)
                    .Text = "Sales Return Transaction Net Total"
                    .TextAlign = ContentAlignment.MiddleRight
                    '.BorderStyle = BorderStyle.FixedSingle
                End With
                Me.lblItemGrossTotal.Add(lbl)
    ...
    Private Sub FetchInvoiceDetails(ByVal invhsysid As String)
        ...
        Dim stQuery As String = ""
        Dim ds As DataSet
        stQuery = "select INVI_ITEM_CODE,INVI_ITEM_DESC,INVI_QTY,INVI_PL_RATE,nvl((select ITED_FC_AMT from OT_INVOICE_ITEM_TED where ITED_I_SYS_ID=INVI_SYS_ID and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM from OM_TED_TYPE where TED_TYPE_CODE='TEDEXP')),0) as Expamt,nvl((select ITED_FC_AMT from OT_INVOICE_ITEM_TED where ITED_I_SYS_ID=INVI_SYS_ID and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM from OM_TED_TYPE where TED_TYPE_CODE='TEDDIS')),0) as Disamt,INVI_DISC_PERC,nvl((select ITED_FC_AMT from OT_INVOICE_ITEM_TED where ITED_H_SYS_ID=INVI_INVH_SYS_ID and ITED_TED_HEAD_ITEM_NUM=1 and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM from OM_TED_TYPE where TED_TYPE_CODE='TEDDIS')),0) as totdisamt from ot_invoice_item where INVI_INVH_SYS_ID=" & invhsysid
        ...
        While count > 0
            ...
            count = count - 1
        End While
        grosstotal = grosstotal - Round(Convert.ToDouble(ds.Tables("Table").Rows.Item(0).Item(7).ToString), 3)
        ...
        lbl = New Label
        n = lblItemTotalDiscountHeader.Count
        With lbl
            .Name = "lblItemTotalDiscountHeader" & n.ToString
            .Text = "Total Discount"
            .Location = New Point(560, currentpositon)
            .Size = New Size(90, 20)
            .Font = New Font("Times New Roman", 9, FontStyle.Bold)
            .TextAlign = ContentAlignment.MiddleRight
            '.BorderStyle = BorderStyle.FixedSingle
        End With
        Me.lblItemTotalDiscountHeader.Add(lbl)
        Me.Controls.Find(currentpage, True)(0).Controls.Add(lbl)

        lbl = New Label
        n = lblItemTotalDiscount.Count
        With lbl
            .Name = "lblItemTotalDiscount" & n.ToString
            .Text = Round(Convert.ToDouble(ds.Tables("Table").Rows.Item(0).Item(7).ToString), 3).ToString("0.00")
            .Location = New Point(650, currentpositon)
            .Size = New Size(90, 20)
            .Font = New Font("Times New Roman", 9, FontStyle.Bold)
            .TextAlign = ContentAlignment.MiddleRight
            '.BorderStyle = BorderStyle.FixedSingle
        End With
        Me.lblItemTotalDiscount.Add(lbl)
        Me.Controls.Find(currentpage, True)(0).Controls.Add(lbl)

        currentpositon = currentpositon + 20

        lbl = New Label
        n = lblItemGrossTotalHead.Count
        With lbl
            .Name = "lblItemGrossTotalHead" & n.ToString
            .Text = "Total Amount"
            .Location = New Point(560, currentpositon)
            .Size = New Size(90, 20)
            .Font = New Font("Times New Roman", 9, FontStyle.Bold)
            ...
            '.BorderStyle = BorderStyle.FixedSingle
        End With
        Me.lblItemGrossTotalHead.Add(lbl)
        Me.Controls.Find(currentpage, True)(0).Controls.Add(lbl)
    ...
    Private Sub FetchSalesOrderDetails(ByVal sohsysid As String)
        ...
        Dim stQuery As String = ""
        Dim ds As DataSet
        stQuery = "select SOI_ITEM_CODE, SOI_ITEM_DESC,SOI_QTY,SOI_PL_RATE,nvl((select ITED_FC_AMT from OT_SO_ITEM_TED where ITED_I_SYS_ID= SOI_SYS_ID and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM from OM_TED_TYPE where TED_TYPE_CODE='TEDEXP')),0) as Expamt,nvl((select ITED_FC_AMT from OT_SO_ITEM_TED where ITED_I_SYS_ID=SOI_SYS_ID and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM from OM_TED_TYPE where TED_TYPE_CODE='TEDDIS')),0) as Disamt,SOI_DISC_PERC,nvl((SELECT ITED_FC_AMT from OT_CUST_SALE_RET_ITEM_TED where ITED_H_SYS_ID= SOI_SOH_SYS_ID and ITED_TED_HEAD_ITEM_NUM=1 and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM  from OM_TED_TYPE where TED_TYPE_CODE='TEDDIS')),0) as totdisamt from OT_SO_ITEM where SOI_SOH_SYS_ID=" & sohsysid
        ds = db.SelectFromTableODBC(stQuery)
        Dim count As Integer = 0
        Dim i As Integer = 0
        count = ds.Tables("Table").Rows.Count
    ...
    Private Sub FetchSalesReturnDetails(ByVal csrhsysid As String)
        ...
        Dim stQuery As String = ""
        Dim ds As DataSet
        stQuery = "select CSRI_ITEM_CODE, CSRI_ITEM_DESC,CSRI_QTY, CSRI_RATE,nvl((select ITED_FC_AMT from OT_CUST_SALE_RET_ITEM_TED where ITED_I_SYS_ID= CSRI_SYS_ID and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM from OM_TED_TYPE where TED_TYPE_CODE='TEDEXP')),0) as Expamt,nvl((select ITED_FC_AMT from OT_CUST_SALE_RET_ITEM_TED where ITED_I_SYS_ID=CSRI_SYS_ID and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM from OM_TED_TYPE where TED_TYPE_CODE='TEDDIS')),0) as Disamt,CSRI_DISC_PERC,nvl((SELECT ITED_FC_AMT from OT_CUST_SALE_RET_ITEM_TED where ITED_H_SYS_ID= CSRI_CSRH_SYS_ID and ITED_TED_HEAD_ITEM_NUM=1 and ITED_TED_TYPE_NUM=(select TED_TAX_DISC_EXP_NUM  from OM_TED_TYPE where TED_TYPE_CODE='TEDDIS')),0) as totdisamt from OT_CUST_SALE_RET_ITEM where CSRI_CSRH_SYS_ID=" & csrhsysid
        ds = db.SelectFromTableODBC(stQuery)
        Dim count As Integer = 0
        Dim i As Integer = 0
        count = ds.Tables("Table").Rows.Count

Module Globals
    ...
    Public HoldInvoiceLoadProcess As Boolean = False
    Public reportsarray As New ArrayList
    Public mastersarray As New ArrayList
    Public settingsarray As New ArrayList
    Public transarray As New ArrayList

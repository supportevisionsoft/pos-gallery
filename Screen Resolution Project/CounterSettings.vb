...
Public Class CounterSettings
    ...
    Private Sub Settings_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            SetResolution()
            If Not settingsarray.Contains("Location Settings") Then
                btnLocationSettings.Enabled = False
            End If
    ...
    Private Sub txtCounterAddLocationCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCtrSettLoccode.TextChanged
        Try
            ...
            If ds.Tables("Table").Rows.Count > 0 Then
                ...
                errLog.WriteToErrorLog("OM_POS_COUNTER locn", stQuery, "")
                ds = db.SelectFromTableODBC(stQuery)
                Dim count As Integer
                Dim i As Integer
                Dim row As System.Data.DataRow
    ...
    Private Sub callEditCountSettings()
        ...
        txtCrtSettEditTLA1.Text = ""
        txtCrtSettEditTLA2.Text = ""
        txtCrtSettEditWLA1.Text = ""
        txtCrtSettEditWLA2.Text = ""
        ...
        If lstviewCountSettings.SelectedItems.Count > 0 Then
            ...
            stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(3).Text & "' and  POCS_COUNTER_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(5).Text & "' and POCS_KEY='LINE_DISP_WLA_1'"
            errLog.WriteToErrorLog("Rowid", stQuery, "")
            ds = db.SelectFromTableODBC(stQuery)
            If ds.Tables("Table").Rows.Count > 0 Then
                txtCrtSettEditWLA1.Text = ds.Tables("Table").Rows.Item(0).Item(0).ToString()
            End If
            ...
            stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(3).Text & "' and  POCS_COUNTER_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(5).Text & "' and POCS_KEY='LINE_DISP_WLA_2'"
            errLog.WriteToErrorLog("Rowid", stQuery, "")
            ds = db.SelectFromTableODBC(stQuery)
            If ds.Tables("Table").Rows.Count > 0 Then
                txtCrtSettEditWLA2.Text = ds.Tables("Table").Rows.Item(0).Item(0).ToString()
            End If
            ...
            stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(3).Text & "' and  POCS_COUNTER_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(5).Text & "' and POCS_KEY='LINE_DISP_TLA_1'"
            errLog.WriteToErrorLog("Rowid", stQuery, "")
            ds = db.SelectFromTableODBC(stQuery)
            If ds.Tables("Table").Rows.Count > 0 Then
                txtCrtSettEditTLA1.Text = ds.Tables("Table").Rows.Item(0).Item(0).ToString()
            End If
            ...
            stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(3).Text & "' and  POCS_COUNTER_CODE= '" & lstviewCountSettings.SelectedItems.Item(0).SubItems(5).Text & "' and POCS_KEY='LINE_DISP_TLA_2'"
            errLog.WriteToErrorLog("Rowid", stQuery, "")
            ds = db.SelectFromTableODBC(stQuery)
            If ds.Tables("Table").Rows.Count > 0 Then
                txtCrtSettEditTLA2.Text = ds.Tables("Table").Rows.Item(0).Item(0).ToString()
            End If
    ...
    Private Sub btnCtrSettEditUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCtrSettEditUpdate.Click
        ...
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditWL1.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_WL_1' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
        ...
        If Not txtCrtSettEditWLA1.Text.Length > 0 Then
            txtCrtSettEditWLA1.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_WLA_1'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditWLA1.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_WLA_1' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_WLA_1','" & txtCrtSettEditWLA1.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If
        ...
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditWL2.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_WL_2' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
        ...
        If Not txtCrtSettEditWLA2.Text.Length > 0 Then
            txtCrtSettEditWLA2.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_WLA_2'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditWLA2.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_WLA_2' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_WLA_2','" & txtCrtSettEditWLA2.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If
        ...
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditTL1.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_TL_1' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
        ...
        If Not txtCrtSettEditTLA1.Text.Length > 0 Then
            txtCrtSettEditTLA1.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_TLA_1'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditTLA1.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_TLA_1' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_TLA_1','" & txtCrtSettEditTLA1.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If
        ...
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditTL2.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_TL_2' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
        ...
        If Not txtCrtSettEditTLA2.Text.Length > 0 Then
            txtCrtSettEditTLA2.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_TLA_2'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            stQuery = "UPDATE OM_POS_OPTIONS_COUNTER_SETUP SET POCS_VALUE = '" & txtCrtSettEditTLA2.Text.Replace("'", "''") & "' where POCS_KEY ='LINE_DISP_TLA_2' AND POCS_LOCN_CODE = '" & txtCtrSettEditLocCode.Text & "'  AND POCS_COUNTER_CODE = '" & txtCtrSettEditCntrCode.Text & "'"
            errLog.WriteToErrorLog("Update Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_TLA_2','" & txtCrtSettEditTLA2.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If
    ...
    Private Sub txtCtrSettEditCntrCode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCtrSettEditCntrCode.TextChanged
        Dim stQuery As String
        Dim ds As DataSet
        stQuery = "select POSCNT_NAME from OM_POS_COUNTER where POSCNT_FRZ_FLAG_NUM = 2 and POSCNT_NO='" & txtCtrSettEditCntrCode.Text & "'"
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then

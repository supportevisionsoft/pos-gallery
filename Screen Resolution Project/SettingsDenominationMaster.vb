...
Public Class SettingsDenominationMaster
    ...
    Private Sub btnLocationMaster_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLocationMaster.Click
        Try
            For Each child As Form In Home.MdiChildren
                child.Close()
                child.Dispose()
            Next child
            SettingsLocationMaster.MdiParent = Home
            SettingsLocationMaster.Show()
        Catch ex As Exception
            errLog.WriteToErrorLog(ex.Message, ex.StackTrace, "Error")
        End Try
    End Sub
